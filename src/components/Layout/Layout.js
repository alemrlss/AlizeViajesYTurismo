...
export const Layout = ({ children }) => {
  ...
  return (
    <>
      <Button className="btn__wpp" position="fixed" zIndex="10" bottom="20px" right="20px" onClick={() => window.open("https://api.whatsapp.com/send?phone=543794077764&text=hola")} height="65px" borderRadius="30px" colorScheme='whatsapp'>
