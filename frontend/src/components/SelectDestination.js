...
export const SelectDestination = ({onSelected, selected, placerholder}) => {
		...
		<Combobox value={selected} onChange={onSelected}>
            ...
            placeholder={placerholder}
				...
				<Transition
					...
					afterLeave={() => setQuery('')}
				>
					<Combobox.Options className="z-10 absolute mt-1 max-h-60 w-96 overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
